...
import { UserData } from "../../../expressjs_server/src/user/user_data";
    ...
    static appRouting(request: IncomingMessage, response: ServerResponse) {
        ...
        if (pathName == "/users" && method == "GET") {
            ...
            request.on('data', (chunk) => {
                ...
                response.end(`<h1 style="color: green">${jsonResponse.password} created successfuly</h1>>`);
            })
            ...
            request.on('data', (chunk) => {
                ...
                if (jsonResponse.email == "omjamnekar@gmail.com" && jsonResponse.password == "123456") {
